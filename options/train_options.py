...
class TrainOptions(BaseOptions):
    def initialize(self, parser):
        ...
        parser.add_argument('--val', type=str, default='', help='path to validation dataset')
        parser.add_argument('--val_img_file', type=str, default='', help='path to validation images folder or list')
